...
| P3-16 | Search placeholder said "Search a player…" though only non-Nets players are searchable | "Search non-Nets players…" — matches the region's accessible name |

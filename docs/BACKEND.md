...
- Headshots: `PlayerSummary.espnAthleteId` from curated Nets/Radar ids, else best-effort ESPN site search (`nba/espn/`) with short timeout + TTL cache; never fails the players response
